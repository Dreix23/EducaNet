...
import EditarProfesorDialog from '@/dialogs/EditarProfesorDialog.vue';
...
<template>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr
                    ...
                    <td class="px-6 py-4">12548685</td>
                    <td class="px-6 py-4">Manuel</td>
                    ...
                    <td class="px-6 py-4 text-center flex justify-center gap-[10px]">
                        ...
                        <router-link to="/profeCode"
                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                            <ArrowBigRightDash
                                class="hover:scale-[1.5] transition-transform duration-300 ease-in-out" />
                        </router-link>
                    </td>
                </tr>
            </tbody>
    ...
    <EditarProfesorDialog :modalActive="editarModalActive" :alumnoSeleccionado="alumnoSeleccionado"
        @closeModal="editarModalActive = false" @editarAlumno="guardarAlumnoEditado" />
</template>
<style scoped>
