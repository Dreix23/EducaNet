...
const addTarea = async () => {
  ...
  const tareaCollectionRef = collection(db, collectionPath);

  try {
    const tareaDocRef = doc(tareaCollectionRef);
    await setDoc(tareaDocRef, tareaData);
    console.log('Tarea agregada en Firebase:', tareaData);
  } catch (error) {
