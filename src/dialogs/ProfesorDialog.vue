...
const buttonStyle = computed(() => props.isEditing ? 'bg-green-500 hover:bg-green-600' : 'bg-blue-500 hover:bg-blue-600');
        ...
        <form @submit.prevent="guardarProfesor">
          <div class="grid gap-6 mb-6">
            <div class="grid grid-cols-3 gap-4 items-center">
              ...
              <input v-model="tempCod" type="text" id="cod" placeholder="Código" class="col-span-2 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
            </div>
            <div class="grid grid-cols-3 gap-4 items-center">
              <label for="nombre" class="text-sm text-gray-900">Nombre</label>
              <input v-model="tempNombre" type="text" id="nombre" placeholder="Nombre" class="col-span-2 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
            </div>
            <div class="grid grid-cols-3 gap-4 items-center">
              <label for="correo" class="text-sm text-gray-900">Correo</label>
              <input v-model="tempCorreo" type="email" id="correo" placeholder="Correo" class="col-span-2 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" :readonly="props.isEditing">
            </div>
            <div class="grid grid-cols-3 gap-4 items-center" v-if="!props.isEditing">
              ...
              <div class="col-span-2 relative">
                <input :type="showPassword ? 'text' : 'password'" v-model="password" placeholder="Contraseña" class="px-3 py-2 border rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-600">
                <button type="button" @click="toggleShowPassword" class="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500">
          ...
          <div class="flex justify-center mt-6">
            <button type="submit" :class="[buttonStyle, 'text-white px-6 py-2 rounded-lg transition duration-200']" :disabled="loading">
